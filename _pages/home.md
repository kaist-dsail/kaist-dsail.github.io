...
<i style="margin-left:12px;">- multimodal LLMs, scientific reasoning, tool use, distillation, video LLMs</i><br>
...
<i style="margin-left:12px;">- graph&ndash;text&ndash;sequence integration, cross-modal alignment, Relational multimodal data</i><br>
...
<i style="margin-left:12px;">- single-cell modeling, virtual cell, perturbation, molecular property prediction, protein&ndash;ligand interaction, generative molecule design, spectra-to-structure reasoning, scientific AI agents, materials discovery</i><br>
&bull; <b>Recommender Systems &amp; User Modeling</b><br>
<i style="margin-left:12px;">- LLM-based recommendation, graph-based recommendation, sequential modeling</i><br>
